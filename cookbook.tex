...
\setlength{\parskip}{0.6em plus 2pt minus 1pt}
\setlength{\parindent}{0pt}
\part{\Large Main Courses}
\hfill \newpage

\loadcategory{recipes/main_courses}

%\input{recipes/main_courses/risotto_patrio}
%\input{recipes/main_courses/pollo_al_cestello}
%\input{recipes/main_courses/soupe_oignon}
%\input{recipes/main_courses/piadine}
%\input{recipes/main_courses/pizza_napoletana}
...
\loadcategory{recipes/desserts}
%\input{recipes/desserts/bundner_nusstorte.tex}
%\input{recipes/desserts/jerrys_cheesecake.tex}
