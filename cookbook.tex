...
% ----------------------------------
%  Turn a folder name like "mains_and_components" into "Mains & components"
% ----------------------------------
\newcommand{\CapitalizeFirst}[1]{%
	\StrLeft{#1}{1}[\firstletterCB]%
	\StrGobbleLeft{#1}{1}[\restlettersCB]%
	\MakeUppercase{\firstletterCB}\restlettersCB%
}
...
%% -----------------------------------
%%  RECIPES: auto-generate a \part for every subfolder of ./recipes/
%%  (alphabetical order), and load its recipe files.
%%  Rename, add, or delete a folder there and this updates on the next compile.
%% -----------------------------------
